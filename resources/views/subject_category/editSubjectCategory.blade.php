...
<div class="content-area py-1">
	<div class="container-fluid">
		...
		<div class="box box-block bg-white">
			...
			<form method="post" action="{{ route('updateSubjectCat') }}" enctype="multipart/form-data">
				@csrf
				<input type="hidden" value="{{$subject_category['id']}}" name="id">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"></div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
							<label>نام دسته بندی</label>
							<input type="text" name="name" class="form-control" value="{{$subject_category['name']}}">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
							<label>توضیحات</label>
							<textarea class="form-control" name="description" rows="10">{{$subject_category['description']}}</textarea>
							<span class="font-90 text-muted"></span>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"></div>
